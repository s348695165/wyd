    ...
    wx.request({
      ...
      success(res) {
        ...
        if (res.data.msg != undefined && res.data.status == 0) {
          ...
          console.log(res.data.start_addr)
          // let detail_addr=res.data.start_addr.detail_addr;
          // let province=res.data.start_addr.province;
          // let city=res.data.start_addr.city;
          // let area=res.data.start_addr.area;
          // let detail_addr1=res.data.end_addr.detail_addr;
          // let province1=res.data.end_addr.province;
          // let city1=res.data.end_addr.city;
          // let area1=res.data.end_addr.area;
          // let qi;
          // let shi;
          // if(province!=''&&city==''){//只有省份的状态
          //   qi = self.atuoGetLocation(province)
          // }else if(province!=''&&city!=''){//省市区的状态
          //    qi = self.atuoGetLocation(province + city + area)
          // }
          // if(province1!=''&&city1==''){//只有省份的状态
          //   shi = self.atuoGetLocation(province1)
          // }else if(province1!=''&&city1!=''){//省市区的状态
          //    qi = self.atuoGetLocation(province1 + city1 + area1)
          // }
